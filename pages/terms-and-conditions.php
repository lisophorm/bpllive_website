...
<h4>1. FINGER PRINT REGISTRATION</h4>

<p>The finger print registration allows participants to save time registering information on each digital asset at Barclays Premier League Live (BPL Live). Once registered participation is possible with one scan. Data will then be held throughout the day until all information, scores, photos are collated and emailed to the participant.</p>

<p>By registering via the finger print scanner you hereby consent to and accept the terms and conditions set out below (in the event you are under 18, a parent or guardian must provide consent on your behalf).</p>

<p>You acknowledge by registering your finger print the associated information may contain Personal Data including Sensitive Personal Data as defined under the UK Data Protection Act 1998. </p>
...
<p>If you choose to, you can also opt to receive marketing material from Barclays, Premier League, Sponsors or your chosen football club when prompted.  The Personal Data will be kept confidential and will not be shared with anyone other than as described in the Privacy Policy.</p>

<h4>2. GREEN SCREEN</h4>
<p>Personalised photograph with the Barclays Premier League Trophy
By having your photograph taken you hereby irrevocably consent to and accept the terms and conditions set out below (in the event that you are under 18, a parent or guardian must provide consent on your behalf).
...
<p>You consent to Barclays, the Premier League, sponsors and organisers and those acting on their behalf to process your Personal Data including potentially Sensitive Personal Data as described in the Privacy Policy or in the following to achieve the above purposes (2):</p>
<ol class="alpha">
<li>To process your image and digitally manipulate it.</li> 
...
<h4>3. CONTROL/ACCURACY/POWER GAMES - AKA Interactive Games</h4>
<p><em>Interactive games where the participant is scored on the power of their kick, the accuracy of the shooting and the control of their dribbling.</em></p>
...
<h4>5. UNDERSTANDINGS</h4>

<p>By registering your finger print you are irrevocably agreeing to the below;
You understand that these Terms and Conditions are intended to be as broad and inclusive as permitted by law and agree that if any portion of these terms and conditions are invalid, the remainder will continue in full legal force and effect. You have read these terms and conditions and understand that by registering your finger print, you are giving up legal rights and remedies on behalf of yourself and your kin, heirs, executors, trustees, personal representatives and/or assigns. </p> 
...
<p><em>We may collect and process the following data about you:</em></p>
<ul>
	<li>Information that you provide by filling in forms on our site www.bpllive.com. This includes information provided at the time of registering on our site, accessing information in connection with  BPL Live, posting material, and/or requiring further services. We may also ask you for information when you report a problem with our site.</li>
...
<h4>How do we collect and use your information?</h4>
<ul>
	<li>We will only collect and use your information where we have lawful grounds and legitimate business reasons to do so.</li>
	...
	<li>If we have collected your information for a particular purpose we will not use it for any unrelated purpose unless you have been informed and where relevant your permission obtained.</li>
...
<ul>
	<li>We may transfer your information to recipients acting on our behalf for the above purposes including third party suppliers of data processing and retention services.</li>
	<li>These recipients are only permitted to use your information for the services or function for which they have been engaged, and in accordance with applicable laws.</li>
	<li>We will not sell, trade, rent or lease your personal information to others. However, if we sell or otherwise transfer all or a substantial part of our business to which our website or the BPLLive relates, you agree that your personal information may be considered to be an asset of our business and may be assigned or otherwise transferred to a third party as part of the sale or transfer of such business.</li>
</ul>
...
<ul>
	...
	<li>We will ensure that suitable safeguards are in place before personal information is transferred to other countries.</li>
	<li>We will ensure that when we outsource any processes we ensure the supplier has appropriate security measures in place and will contractually require them to comply with these Privacy Principles.</li>
</ul>
