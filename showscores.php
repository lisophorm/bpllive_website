...
switch($_GET['share_type']) {
	case "TWITTER":
	$incrementfield="twitter_click_skills";
	break;
	case "FACEBOOK":
	$incrementfield="facebook_click_skills";
	break;
	default:
	$incrementfield="email_click_skills";
	break;
}
...
<meta property="og:image" content="http://www.bpllive.com/email/scores/<?php echo $photo['urn']; ?>.png" /> 
<meta property="og:image:type" content="image/jpeg" />
<meta property="og:image:width" content="280" />
<meta property="og:image:height" content="241" />
<meta property="og:description" content="Here's how I did at the Skills Zone - I tested my skills at Barclays Premier League Live in Johannesberg, South Africa." />
...
<div style="width:850px;margin-left:auto;margin-right:auto;background-color:#FFF;">
  <div style="width:369px;float:left;background-color:#ffffff;margin:0px;padding:0px;">
    ...
    <p style="font-size:35px;color:#1e3052">Here's how I did at the Skills Zone</p>
    <p style="font-size:14px;color:#1e3052">I tested my skills at Barclays Premier League Live in Johannesberg, South Africa.</p>
    <p style="font-size:14px;color:#1e3052">&nbsp;</p>
    </p>
  </div>
  <div style="width:457px;float:right;background-color:#ffffff;border:1px solid #000000;box-shadow: 5px 5px 5px #888888;margin-bottom:20px;text-align:center;padding-top:20px;"><a href="#"><img class="centralimage" style="border:none;" src="http://www.bpllive.com/email/scores/<?php echo $user['urn']; ?>.png" alt="" width="420" /></a><div style="text-align:center;">
      <div class="buttons" style="padding-top:10px;padding-bottom:20px;"><a href="/sharescore.php?urn=<?php echo $user['urn']; ?>&share_type=TWITTER"><img style="border:none;" src="/landingpage_assets/twittershare.gif" width="32" height="27" alt="Share on Twitter" /></a><a href="/sharescore.php?urn=<?php echo $user['urn']; ?>&share_type=FACEBOOK"><img src="/landingpage_assets/fbshare.gif" style="border:none;" width="38" height="27" alt="Share on Facebook" /></a></div>
      </div>
