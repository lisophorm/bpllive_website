...
function email_template($part_string){
	...
	$blocks = array(
		...
		'c'=>array(
				'filename'=>'clubzone',
				'facebook'=>urlencode('I got my hands on the Barclays Premier League trophy - head to Barclays Premier League Live for your chance to do the same.'),
		...
		return '<table border="0" cellpadding="0" cellspacing="0" width="100%" style="padding-top: 10px;">
										<tr>
											...
											<td align="right" width="30">
												<a href="https://www.facebook.com/dialog/feed?app_id=830620426955447&display=popup&name='.$blocks[$p]['facebook'].'&link=&redirect_uri=http%3A%2F%2Fwww.bpllive.com%2F&picture=#image_'.$p.'_enc#"><img src="http://www.bpllive.com/email/img/facebook.gif" alt="" width="25" height="25" /></a>
											</td>
											<td align="right" width="30">
